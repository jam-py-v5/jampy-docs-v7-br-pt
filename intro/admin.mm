...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      When new project is created with jam-project, there are only 9 records (ending with ID=5) and each record might have corresponding record in SYS_FIELDS (ie Cadastros, Registros, Details, with ID 2,3,4 respectively)
    </p>
  </body>
</html></richcontent>
</node>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    ...
    <p>
      Ie, Group &quot;test import&quot; has a Table with ID=8, and we want to move it to Group Registros with ID=3:
    </p>
    <p>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    ...
    <p>
      However, some rows have F_DELETED_FLAG set and no F_SOFT_DELETE, which is ok since we do not want soft delete for this tables (ie Consumer table in Demo, or Cadastros Group).
    </p>
  </body>
</html></richcontent>
</node>
